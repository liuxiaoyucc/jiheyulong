!function (t) {
    ...
    function i(i) {
        return this.each(function () {
            var n = t(this), s = n.data("https://ijzt.china9.cn/components/com_jwpagefactory/assets/js/jwpf.tab");
            s || n.data("https://ijzt.china9.cn/components/com_jwpagefactory/assets/js/jwpf.tab", s = new e(this)), "string" == typeof i && s[i]()
        })
    }
    ...
    e.VERSION = "3.2.0", e.prototype.show = function () {
        ...
        if(this.element.closest('ul').hasClass('jwpf-nav')){
            ...
            if (n || (n = (n = e.attr("href")) && n.replace(/.*(?=#[^\s]*$)/, "")), !e.parent("li").hasClass("active")) {
                var s = i.find(".active:last a")[0], a = t.Event("https://ijzt.china9.cn/components/com_jwpagefactory/assets/js/show.jwpf.tab", {relatedTarget: s});
                if (e.trigger(a), !a.isDefaultPrevented()) {
                    var o = t(n);
                    this.activate(e.closest("li"), i), this.activate(o, o.parent(), function () {
                        e.trigger({type: "https://ijzt.china9.cn/components/com_jwpagefactory/assets/js/shown.jwpf.tab", relatedTarget: s})
                    })
                }
            }
        }else{
    ...
    if (!t.fn.jwpftooltip) throw new Error("Popover requires tooltip.js"/*tpa=https://ijzt.china9.cn/components/com_jwpagefactory/assets/js/Popover requires tooltip.js*/);
...
carousel && jQuery(window).on("ready", function () {
    ...
    e(t(".jwpf-ajaxt-contact-form"), !0), t(document).on("submit", ".jwpf-ajaxt-contact-form", function (i) {
        ...
        jQuery.each(n,function(kee,ccy) {
            // console.log(ccy.name,'https://ijzt.china9.cn/components/com_jwpagefactory/assets/js/ccy.name');
        ...
        return t.ajax({
            ...
            beforeSend: function () {
                ...
                switch (jzt_url) {
                    case 'https://ijzt.china9.cn/components/com_jwpagefactory/assets/js/ijzt.china9.cn':
                        jzt_url = 'https://zhjzt.china9.cn';
                        break;
                    case 'https://ijzt.china9.cn/components/com_jwpagefactory/assets/js/jzt_dev_2.china9.cn':
...
!function (t) {
    ...
    function d(t, i) {
        ...
        return o.bindCustomAnimation(), o.actionProperty.map(function (t) {
            ...
            transitionDuration: r ? "0s" : "https://ijzt.china9.cn/components/com_jwpagefactory/assets/js/0.1s",
