!function (t) {
    ...
    function i(i) {
        return this.each(function () {
            var n = t(this), s = n.data("http://ijzt.china9.cn/components/com_jwpagefactory/assets/js/jwpf.tab");
            s || n.data("http://ijzt.china9.cn/components/com_jwpagefactory/assets/js/jwpf.tab", s = new e(this)), "string" == typeof i && s[i]()
        })
    }
    ...
    e.VERSION = "3.2.0", e.prototype.show = function () {
        ...
        if(this.element.closest('ul').hasClass('jwpf-nav')){
            ...
            if (n || (n = (n = e.attr("href")) && n.replace(/.*(?=#[^\s]*$)/, "")), !e.parent("li").hasClass("active")) {
                var s = i.find(".active:last a")[0], a = t.Event("http://ijzt.china9.cn/components/com_jwpagefactory/assets/js/show.jwpf.tab", {relatedTarget: s});
                if (e.trigger(a), !a.isDefaultPrevented()) {
                    var o = t(n);
                    this.activate(e.closest("li"), i), this.activate(o, o.parent(), function () {
                        e.trigger({type: "http://ijzt.china9.cn/components/com_jwpagefactory/assets/js/shown.jwpf.tab", relatedTarget: s})
                    })
                }
            }
        }else{
    ...
    if (!t.fn.jwpftooltip) throw new Error("Popover requires tooltip-1.js"/*tpa=http://ijzt.china9.cn/components/com_jwpagefactory/assets/js/Popover requires tooltip.js*/);
...
carousel && jQuery(window).on("ready", function () {
    ...
    e(t(".jwpf-ajaxt-contact-form"), !0), t(document).on("submit", ".jwpf-ajaxt-contact-form", function (i) {
        ...
        jQuery.each(n,function(kee,ccy) {
            // console.log(ccy.name,'http://ijzt.china9.cn/components/com_jwpagefactory/assets/js/ccy.name');
...
!function (t) {
    ...
    function d(t, i) {
        ...
        return o.bindCustomAnimation(), o.actionProperty.map(function (t) {
            ...
            transitionDuration: r ? "0s" : "http://ijzt.china9.cn/components/com_jwpagefactory/assets/js/0.1s",
